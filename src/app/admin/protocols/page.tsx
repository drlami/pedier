    ...
    <div className="space-y-8">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-muted-foreground">Create, edit, or delete clinical protocols.</p>
        </div>
        <Button asChild>
          ...
          <CardContent>
            <div className="space-y-4">
              {protocols.map((protocol) => (
                <div key={protocol.id} className="flex items-center justify-between p-3 bg-secondary/50 rounded-lg">
                  <div>
