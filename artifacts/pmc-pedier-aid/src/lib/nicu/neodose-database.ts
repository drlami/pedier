...
export const neonateDrugs: NeonateDrug[] = [
...

  {
    ...
    category: 'Electrolyte & Metabolic',
    indications: ['Symptomatic neonatal hypoglycaemia (BG < 2.6 mmol/L)', 'Asymptomatic hypoglycaemia not responding to feed', 'Hyperinsulinism — acute glucose rescue'],
...

  {
    ...
    category: 'Electrolyte & Metabolic',
    indications: ['Neonatal hyperglycaemia (BG > 10–12 mmol/L) on TPN in ELBW/VLBW infants', 'Hyperglycaemia causing osmotic complications'],
    ...
    cautions: [
      ...
      'Target BG: 5–10 mmol/L (avoid tight control — hypoglycaemia risk)',
      'Hold if BG < 5 mmol/L; STOP if BG < 3 mmol/L and give dextrose bolus',
    ...
    calculate: (weight) => {
      ...
      return {
        ...
        basisNote: 'Prime line with 5–10 mL solution before connecting. Target BG 5–10 mmol/L.',
        warningNote: 'Prime tubing — insulin adsorbs to plastic. Check BG q30 min until stable. Hold if BG < 5 mmol/L.',
      };
    },
  },
